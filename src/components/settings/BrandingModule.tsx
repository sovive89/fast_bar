...
import type { IntegrationRow } from "@/lib/integrations.functions";
import {
  brandingStyle,
  hasReadableContrast,
  publicBaseUrl,
...
/**
 * Identidade visual do estabelecimento: nome, logo, cor de destaque, redes e o QR code do balcão.
 *
 * Virou componente à parte (era a rota /caixa/marca inteira) porque agora é a metade visual da aba
 * "Perfil" em Configurações, ao lado dos dados cadastrais do negócio. A config continua na mesma
 * linha "branding" de fastbar_integrations — quem já tinha configurado não perde nada.
 */
